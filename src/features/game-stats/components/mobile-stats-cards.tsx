              ...
              <div className="flex flex-col flex-1 min-w-0">
                <div className="flex items-start justify-between gap-3 w-full">
                  <div className="flex flex-col min-w-0 flex-1">
                    <div className="flex flex-wrap items-center gap-2">
                      <GameNameButton
                        ...
                        gameId={game.id}
                        onClick={onNameClick}
                        className="text-left text-sm font-black text-white uppercase italic truncate"
                      />

                      {isPlatinum && (
                        <span className="shrink-0 inline-flex items-center rounded-full border border-yellow-300/40 bg-gradient-to-r from-yellow-500/20 via-amber-300/10 to-yellow-500/20 px-2 py-0.5 text-[9px] font-black uppercase tracking-[0.2em] text-yellow-200 shadow-[0_0_12px_rgba(234,179,8,0.3)]">
                          Platina
                        </span>
                      )}
                    </div>
                    ...
                    <div className="mt-2.5 flex flex-wrap gap-2">
                      <span className="inline-flex items-center gap-1.5 text-yellow-300 bg-yellow-500/10 px-2.5 py-1 rounded-lg border border-yellow-500/20">
                      ...
                      <span className="inline-flex items-center gap-1.5 text-white/70 bg-white/[0.03] px-2.5 py-1 rounded-lg border border-white/5">
                        <AccessTimeIcon
                          sx={{ fontSize: 14 }}
                  ...
                  <div className="flex items-center gap-1 shrink-0 -mt-1 -mr-2">
                    <button
                      onClick={() => onEdit(game)}
                      className="flex items-center justify-center w-8 h-8 rounded-lg text-white/45 hover:text-white hover:bg-white/10 transition-all active:scale-90"
                      aria-label="Editar"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center w-8 h-8 rounded-lg text-white/45 hover:text-red-400 hover:bg-red-400/10 transition-all active:scale-90"
                      aria-label="Excluir"
                    >
