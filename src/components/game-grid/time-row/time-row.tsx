...
export const TimeRow = ({
  ...
  return (
    <div className="group flex items-center flex-wrap justify-between p-3 bg-white/[0.03] border border-white/5 rounded-lg hover:bg-white/[0.06] transition-colors relative overflow-hidden">
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-xs md:text-md font-bold text-gray-300 uppercase tracking-wider">
          {label}
        </span>
      </div>
